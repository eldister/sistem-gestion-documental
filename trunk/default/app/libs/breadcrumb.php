...
class Breadcrumb
{
    ...
    public function display()
    {
        ...
        {
            return "<li class='{$this->attrs['class_li']}'>" . implode('', $html) . '</li>';
        }
        else
        {
            return "<li class='{$this->attrs['class_li']}'>" . implode("<li class='{$this->attrs['class_separator']}'><a href='javascript: void(0)'>{$this->attrs['separator']}</a></li>", $html) . '</li>';
        }
    }
